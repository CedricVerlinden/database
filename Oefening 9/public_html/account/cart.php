                ...
                <div class="cart">
                    ...
                    <div class="right">
                        <form action="./checkout.php" method="post">
                            ...
                            <input type="hidden" name="subtotal" value="<?php getCartTotal($_SESSION["userid"]) ?>">
                            <input type="hidden" name="btw" value="<?php $btw ?>">
                            <input type="hidden" name="total" value="<?php getCartTotal(($_SESSION["userid"])) + $btw ?>">
